...
export default function Main() {
  ...
  const getLibros = async () => {
    const response = await fetch(host + "/api/getlibros");
  ...
  function guardarNuevoLibro() {
    handleCloseAgregar();
    axios
      .post(host +"/api/libro", libroNuevo)
      .then((res) => {
        getLibros();
      });
  }
  ...
  function guardarLibroEditado() {
    handleCloseEditar();
    axios.put(host + "/api/libro", libroNuevo).then((res) => {
      getLibros();
    });
  }
  ...
  function eliminarLibro() {
    setOpenDelete(false);
    axios.delete(host + `/api/deletelibro?ISBN=${libroNuevo.isbn}`).then((res) => {
